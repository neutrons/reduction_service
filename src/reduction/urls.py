...
urlpatterns = patterns('',
    ...
    url(r'^(?P<instrument_name>\w+)/configuration/(?P<config_id>\d+)/delete$','reduction.views.reduction_configuration_delete', name='reduction_configuration_delete'),
    url(r'^(?P<instrument_name>\w+)/configuration/(?P<config_id>\d+)/(?P<reduction_id>\d+)/delete$', 'reduction.views.reduction_configuration_job_delete', name='reduction_configuration_job_delete'),
