...
urlpatterns = patterns('',
    ...
    url(r'^(?P<instrument_name>\w+)/configuration/$', 'reduction.views.configuration_options', name='reduction_new_configuration'),
    url(r'^(?P<instrument_name>\w+)/configuration/(?P<config_id>\d+)/$', 'reduction.views.configuration_options', name='configuration_options'),
